...
/*
  //!This is [put]
  Uri uri = await Uri.parse("$baseUrl/todos/6"); //6chi id dagi mapni opkeladi
  myHTTP.Response responsePut = await myHTTP.put(
    uri,
    headers: <String, String>{
      "Content-Type": "application/json; charset=UTF-8"
    },
    body: jsonEncode({'country': 'Parij'}), // country sini Parijga o'zgartiradi
  );
  */
}
